...
<body>
    ...
    <form action="formulario1.php" method="get">
        <fieldset>
            ...
            <input type="checkbox" name="ofertas" value="" checked> Deseo recibir información sobre novedades y ofertas.<br><br>
            <input type="checkbox" name="condiciones" value=""> Declaro haber leído y aceptar las condiciones generales del programa y la normativa sobre protección de datos.<br><br>
